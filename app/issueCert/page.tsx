...
function Page() {
    ...
    const attest = async () => {
        ...
        notifySuccess("Attestation Id" + newAttestationUID); // Show success toast
                        ...
                        <form>
                            <div className="p-4.5">
                                ...
                                <button
                                    ...
                                    className={`mb-0.5 mt-2 flex w-full justify-center rounded bg-primary p-3 font-medium text-gray ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                >
                                    {loading ? 'Processing...' : 'Issue Certificate'} {/* Change button text based on loading state */}
                                </button>
                            </div>
                        </form>
                    </div>
