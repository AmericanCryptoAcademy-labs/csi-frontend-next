...
const SignIn: React.FC = () => {
  ...
  const validatePassword = (password: string) => {
    ...
    return hasSixCharacters && hasCapitalLetter;
  };
  ...
  return (
    <>
      ...
      <div className="relative  rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="absolute bottom-3 left-3 "><ul className="flex items-center gap-2 2xsm:gap-4">
          <DarkModeSwitcher /></ul></div>
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <p className=' text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>Certificate Standards Institute</p>
              </Link>
              <p className="mt-6 2xl:px-20">
                CSI is focused on large industry and government offices who want their own, controlled white-labeled certification centers connected to the overall standards that are interoperable and secured by the decentralized blockchain.
